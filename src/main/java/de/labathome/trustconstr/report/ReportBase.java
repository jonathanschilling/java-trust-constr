...
public abstract class ReportBase {
	...
	/** @return per-column header labels */
	protected abstract String[] columnNames();

	/** @return per-column display widths (number of characters per cell) */
	 ...
	 *
	 * @return per-column format specs, parallel to {@link #columnNames()}
	 */
