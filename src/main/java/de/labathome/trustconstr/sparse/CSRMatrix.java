...
public final class CSRMatrix {
	...
	/**
	 * Build from any {@link de.labathome.trustconstr.matrix.Matrix}. Routes
	 * sparse {@link de.labathome.trustconstr.matrix.SparseMatrix} sources
	 * directly to {@link de.labathome.trustconstr.matrix.SparseMatrix#toCSR}
