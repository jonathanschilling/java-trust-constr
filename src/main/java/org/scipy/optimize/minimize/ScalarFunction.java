...
public class ScalarFunction {
	 ...
	 */
	Hessian hess;
	FiniteDifferenceMethod hessFD;
	HessianUpdateStrategy hessUpdateStrategy;
	boolean hasHess;
	Matrix H;
	...
	public ScalarFunction(Function fun, Matrix x0) {
		this.fun = fun;
		this.x0 = x0;
	}

	public ScalarFunction args(Object args) {
		this.args = args;
		return this;
	}

	public ScalarFunction grad(Gradient grad) {
		this.grad = grad;
		this.gradFD = null;
		this.hasGrad = true;
		return this;
	...
	public ScalarFunction grad(FiniteDifferenceMethod grad) {
		this.grad = null;
		this.gradFD = grad;
		this.hasGrad = true;
		return this;
	...
	public ScalarFunction hess(Hessian hess) {
		this.hess = hess;
		this.hessFD = null;
		this.hasHess = true;
		return this;
	...
	public ScalarFunction hess(FiniteDifferenceMethod hess) {
		this.hess = null;
		this.hessFD = hess;
		this.hasHess = true;
		return this;
	...
	public ScalarFunction finiteDiffRelStep(double finiteDiffRelStep) {
		this.finiteDiffRelStep = finiteDiffRelStep;
		return this;
	}

	public ScalarFunction finiteDiffBounds(FiniteDifferenceBounds finiteDiffBounds) {
